...
import DeleteItem from './delete_forms/DeleteItem';
import DeleteCategory from'./delete_forms/DeleteCategory'
          ...
          <div className="notify-icons">
            <ul>
              ...
              <div className="menu-icon top-margin">
                ...
                <MenuItem primaryText="logout" className="logout" href="/users/sign_out" data-method="delete"/>
              </div>
              </IconMenu>
              </li>
            </ul>
